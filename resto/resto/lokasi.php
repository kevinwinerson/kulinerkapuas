...
$query="SELECT * FROM restoran where idlokasi= $id ORDER BY idrestoran DESC LIMIT $start, $per_page";
$result = $koneksi->query($query);

// Hitung total jumlah data
$total_query = "SELECT COUNT(*) as total FROM restoran where idlokasi= $id";
...
<main style="background-image: url('IMG/Tugu_Batang_Garing.JPG');  background-size: cover;">
  ...
  <ul class="pagination px-2">
    <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
      <a class="page-link" href="lokasi.php?page=<?php echo ($page <= 1) ? 1 : ($page - 1); ?>">Previous</a>
    </li>
    <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
      <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>"><a class="page-link" href="lokasi.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php endfor; ?>
    <li class="page-item <?php echo ($page >= $total_pages) ? 'disabled' : ''; ?>">
      <a class="page-link" href="lokasi.php?page=<?php echo ($page >= $total_pages) ? $total_pages : ($page + 1); ?>">Next</a>
    </li>
  </ul>
</nav>
    </div>
